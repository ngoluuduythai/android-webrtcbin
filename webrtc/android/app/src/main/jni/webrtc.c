...
#define RTP_CAPS_H264 "application/x-rtp,media=video,encoding-name=H264,payload=100,clock-rate=90000"
...
start_pipeline (WebRTC * webrtc)
{
    ...
    GstWebRTCRTPTransceiver *trans = NULL;
    GstCaps *video_caps = gst_caps_from_string("application/x-rtp,media=video,encoding-name=H264,payload=100,clock-rate=90000");
